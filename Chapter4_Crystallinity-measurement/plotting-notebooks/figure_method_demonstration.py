...
def plot_XRD_fitted_spectrum_method_demonstration(
    file_path, 
    width=6., height=6.,
    ...
    if save_fig:
        ...
        filename = f"fig_XRD_method_demonstration.{save_format}"
...
def plot_DSC_fitted_spectrum_method_demonstration(
    file_path, 
    width=6., height=6.,
    ...
    if save_fig:
        ...
        # Create filename
        filename = f"fig_DSC_method_demonstration.{save_format}"
        filepath = os.path.join(folder_to_save, filename)

...
def plot_solubility_fvt(
    ...
    ax1.set_ylabel(r'$C_0$ / $\mathrm{cm^{3}(STP) \, cm^{-3}}$')
    ...
    for i, pressure in enumerate(unique_pressures_peeka):
    ...
    if save_fig:
        ...
        filename = f"fig_solubility_fvt.{save_format}"
